...
#!perl
#line 29
    eval 'exec C:\Users\User\Documents\GitHub\SitenewShop\xampp\perl\bin\perl.exe -S $0 ${1+"$@"}'
...
my $perlpath = 'C:\Users\User\Documents\GitHub\SitenewShop\xampp\perl\bin\perl.exe';
