...
if ('C:\Users\User\Documents\GitHub\SitenewShop\xampp\php\pear ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('C:\Users\User\Documents\GitHub\SitenewShop\xampp\php\pear '). PATH_SEPARATOR .  get_include_path());
    $raw = false;
} else {
